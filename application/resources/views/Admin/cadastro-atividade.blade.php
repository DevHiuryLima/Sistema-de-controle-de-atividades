                        ...
                        @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <fieldset class="form-group">
                                        <textarea style="padding: 10px;" id="descricao" name="descricao" cols="48" rows="3" placeholder="Insira a sua descrição." required=""></textarea>
                                    </fieldset>
                                </div>
                            </div>
...
function adicionarMinimoCaracteres() {
 ...
 $(function() {
     $('form[name="formCadastroAtiviade"]').submit(function(event) {
        ...
        .fail(function(jqXHR){
            if (jqXHR.responseJSON.message == 'Passou do horário para manutenções urgente!') {
